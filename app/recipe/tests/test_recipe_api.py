...
class RecipeImageUploadTest(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Thai vegan curry')
        recipe2 = sample_recipe(user=self.user, title='Ambergin vegan curry')
        tag1 = sample_tags(user=self.user, name='Vegan')
        tag2 = sample_tags(user=self.user, name='Vegetarian')

        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='Fish and Meat Chips')
    ...
    def test_filter_recipe_by_ingredient(self):
        """Test return recipe by ingredients"""

        recipe1 = sample_recipe(user=self.user, title='Magharitta Tomates')
        recipe2 = sample_recipe(user=self.user, title='Chicken Caciatos')
        ingredient1 = sample_ingredient(user=self.user, name='Feta Cheese')
        ingredient2 = sample_ingredient(user=self.user, name='Chicken')

        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Steak and Caciatos')
